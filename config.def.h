...
static Key keys[] = {
    ...
    { MODKEY,              XK_v,      spawn, SHCMD("xfce4-popup-clipman")},                                     /* super v          | 复制历史*/
...
static Button buttons[] = {
    ...
    { ClkStatusText,       0,               Button1,          clickstatusbar,{0} },                                   // 左键        |  点击状态栏   |  根据状态栏的信号执行 $DWM/dwmstatusbar.sh $signal L
    { ClkStatusText,       0,               Button2,          clickstatusbar,{0} },                                   // 中键        |  点击状态栏   |  根据状态栏的信号执行 $DWM/dwmstatusbar.sh $signal M
    { ClkStatusText,       0,               Button3,          clickstatusbar,{0} },                                   // 右键        |  点击状态栏   |  根据状态栏的信号执行 $DWM/dwmstatusbar.sh $signal R
